<template>
  <section id="experience" class="py-20 px-6 sm:px-12 relative scroll-mt-24">
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
      <div class="absolute top-24 left-10 w-72 h-72 bg-amber-500/5 rounded-full blur-3xl"></div>
      <div class="absolute bottom-16 right-8 w-96 h-96 bg-purple-500/5 rounded-full blur-3xl"></div>
    </div>
  </section>
</template>
