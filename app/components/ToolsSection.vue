<template>
  <section id="tools" class="py-20 px-6 sm:px-8 relative scroll-mt-24">
    <div class="max-w-6xl mx-auto">
      ...
      <div class="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8 auto-rows-[1fr]">
        <div
          ...
          :key="tool.name + index"
          :class="['col-span-1 md:col-span-3', tool.span]"
        >
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
      <div class="absolute -top-10 -left-10 w-72 h-72 bg-sky-500/5 rounded-full blur-3xl"></div>
      <div class="absolute bottom-10 right-0 w-96 h-96 bg-amber-500/5 rounded-full blur-3xl"></div>
    </div>
  </section>
</template>
